...
class ResponseWrapper(Response):
    ...
    def __init__(self, data=None, error_code=None, template_name=None, headers=None, exception=False, content_type=None, error_message=None, message=None, response_success=True, status=None):
        ...
        if error_code is not None:
            ...
            data = {
                ...
                "status": status,
                "referenceError": None,
                "@baseType": "application/vnd.error+json",
                "@schemaLocation": None,
                "@type": "Error"
            }
